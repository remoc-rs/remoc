...
## 0.20.4 - 2026-09-17
### Fixed
- rtc: servers and request receivers are Sync again

## 0.20.3 - 2026-09-16
### Added
- transport examples: QUIC

## 0.20.2 - 2026-09-11
### Added
- `explicit-auto-traits` feature to reduce trait solver recursion depth and compile
  times by explicitly implementing `Send` and `Sync` for Remoc types.
